...
<%
	...
	List<CALBOARD> clist = dao.getCalViewList("kh", yyyyMM);
%>
...
<%=dayOfWeek %>
	...
	<table id="calendar">
		...
		%>
				<td>
					<a class="countview" href="calendar.do?command=list&year=<%=year%>&month=<%=month%>&date=<%=i%>" style="color: <%=Util.fontColor(i, dayOfWeek)%>; font-weight: bold;"><%=i %></a>
